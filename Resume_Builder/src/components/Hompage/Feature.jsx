...
const Feature = () => {
  return (
    <div className=" py-10 px-20">
        <span className=" pb-10 flex justify-center text-5xl font-bold text-[#8910F1] "> Feature</span>
        <div className=" flex justify-between gap-[110px]">
            <div className=" ">
                ...
                <img src={Rectangle} alt="Spiral" className=" mt-[70px] mb-[67px]"/>
                <div className="flex flex-col gap-5">
            ...
            <div>
                ...
                <img src={Spiral} alt="Spiral" className=" ml-[-80px]" />
            </div>
        </div>
