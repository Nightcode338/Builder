    ...
    <div className=" w-fit overflow-hidden">
      ...
      <div className=" px-20 my-24 flex justify-between gap-8">
        ...
        <img src={Arrow2} alt="" className="absolute left-[78%] bottom-[42%]"/>
          ...
          <p className=" text-lg font-bold leading-[22px] tracking-tighter"> By clicking <span className=" text-[#8910F1]">Build resume</span>, you agree to our <span className=" text-[#407FF9] cursor-pointer">Terms of use</span> and <span className="text-[#407FF9] cursor-pointer">Privacy Policy</span></p>
        </div>
      </div>
      <Footer />
    </div>
